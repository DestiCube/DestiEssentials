...
public class PlayerTeleportRequestAcceptEvent extends DuckPlayerEvent {

    TeleportRequest request;

    public PlayerTeleportRequestAcceptEvent(DestiPlayer player, TeleportRequest request) {
        super(player.player());
